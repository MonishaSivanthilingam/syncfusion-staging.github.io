...
document.getElementById('columns').onchange = function (e) {
    column = kanbanObj.columns.filter(function (args) { return args.keyField === e.value; });
};

document.getElementById('allowDrag').onchange = function (e) {
    column.allowDrag = e.value;
};

document.getElementById('allowDrop').onchange = function (e) {
    column.allowDrop = e.value;
};
